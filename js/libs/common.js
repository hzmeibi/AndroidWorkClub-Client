...
// document.onkeypress=shield;//屏蔽选择函数
// document.onselectstart=shield;//用户选择

//document.onkeydown=shield;//鼠标事件
//document.onkeyup=shield;
//document.ondragstart=shield;
// H5 plus事件处理
...
document.addEventListener('DOMContentLoaded',function(){
	...
	// document.getElementsByClassName("photoInfo")[0].onselectstart=function (){
	// 	alert(1);
	// 	// return true;
	// }
...
w.clicked=function(id,wa,ns,ws){
	...
	if(w.plus){
		...
		var pre='/static/';//'http://192.168.1.178:8080/h5/';
